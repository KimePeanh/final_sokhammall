                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                        width: width * 0.95,
                        child: Text(
                          AppLocalizations.of(context)!.translate("choosetowithdraw"),
                          style: TextStyle(fontWeight: bold, fontFamily: 'kh'),
                          textScaleFactor: 1.1,
                        )),
                    SizedBox(
                    ...
                    //       //         hintText: "${BlocProvider.of<AccountBloc>(context).state.user!.phone}"),
                    //       //   ),
                    //       // ))
                    //     ],
                    //   ),
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => Summary(
                                      ...
                                      open_every: int.parse(month[index].toString()),
                                      money_to_paid: "${sum / (12 / month[index])}",
                                      phonenumber: "${BlocProvider.of<AccountBloc>(context).state.user!.phone}",
                                    )));
                      },
                    )
                  ],
