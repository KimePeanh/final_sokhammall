...
class LanguageBloc extends Bloc<LanguageEvent, LanguageState> {
  ...
  Stream<LanguageState> _mapLanguageSelectedToState(
    ...
    } else if (selectedLanguage == Language.TH) {
      yield* _loadLanguage('th', 'TH');
    } else if (selectedLanguage == Language.ZH) {
      yield* _loadLanguage('zh', 'CN');
    }
    if (selectedLanguage == Language.EN && defaultLang != "en") {
