...
class ProductListByPriceGroupPage extends StatelessWidget {
  final PriceGroup priceGroup;
  ProductListByPriceGroupPage({required this.priceGroup});
  @override
          ...
          return Scaffold(
            ...
            body: BlocProvider(
              create: (BuildContext context) => ProductListingBloc(
                  productListingRepository: ProductListByPriceGroupRepo(
                      isAuthenticated:
